    ...
    <>
      ...
      <div className="aboutContent">
        <p>
          ...
          topic to which the audience can completely rely on. Spatikal is
          derived from a Sanskrit word 'SPHATIKA’ which means ‘crystal’. A
          crystal is a representation of transparency and uniqueness which is
          what we aim on inculcating in our business model. We want to project
          transparency in the information & content we provide and uniqueness in
      ...
      <div className="aboutContent">
        <p>
          ...
          views on various topics and build up a trust with our audience on the
